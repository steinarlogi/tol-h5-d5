...
window.onload = function init() {
    ...
    gl.uniform1f( gl.getUniformLocation(program, "phong2"), 1.0 );
...
function changeColoring() {
    ...
    if (phong) {
        gl.uniform1f( gl.getUniformLocation(program, "phong"), 1.0 );
        gl.uniform1f( gl.getUniformLocation(program, "phong2"), 1.0 );
        document.getElementById("colorInformation").innerHTML = "Notar phong litun";
    } else {
        gl.uniform1f( gl.getUniformLocation(program, "phong"), 0.0 );
        gl.uniform1f( gl.getUniformLocation(program, "phong2"), 0.0 );
        document.getElementById("colorInformation").innerHTML = "Notar goraud litun";
    }
}
